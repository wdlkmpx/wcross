...
freebsd12='
i686|freebsd12|http://ftp-archive.freebsd.org/pub/FreeBSD/releases/i386/12.3-RELEASE/base.txz
x86_64|freebsd12|http://ftp-archive.freebsd.org/pub/FreeBSD/releases/amd64/12.3-RELEASE/base.txz
aarch64|freebsd12|http://ftp-archive.freebsd.org/pub/FreeBSD/releases/arm64/12.3-RELEASE/base.txz
#powerpc|freebsd12|http://ftp-archive.freebsd.org/pub/FreeBSD/releases/powerpc/powerpc/12.3-RELEASE/base.txz
#powerpc64|freebsd12|http://ftp-archive.freebsd.org/pub/FreeBSD/releases/powerpc/powerpc64/12.3-RELEASE/base.txz
###sparc64|freebsd12|http://ftp-archive.freebsd.org/pub/FreeBSD/releases/sparc64/12.3-RELEASE/base.txz'

freebsd13='
i686|freebsd13|http://ftp-archive.freebsd.org/pub/FreeBSD/releases/i386/13.1-RC3/base.txz
x86_64|freebsd13|http://ftp-archive.freebsd.org/pub/FreeBSD/releases/amd64/13.1-RC3/base.txz
aarch64|freebsd13|http://ftp-archive.freebsd.org/pub/FreeBSD/releases/arm64/13.1-RC3/base.txz
riscv64|freebsd13|http://ftp-archive.freebsd.org/pub/FreeBSD/releases/riscv/riscv64/13.1-RC3/base.txz
powerpc|freebsd12|http://ftp-archive.freebsd.org/pub/FreeBSD/releases/powerpc/powerpc/13.1-RC3/base.txz
powerpc64|freebsd12|http://ftp-archive.freebsd.org/pub/FreeBSD/releases/powerpc/powerpc64/13.1-RC3/base.txz
powerpc64le|freebsd12|http://ftp-archive.freebsd.org/pub/FreeBSD/releases/powerpc/powerpc64le/13.1-RC3/base.txz
powerpcspe|freebsd12|http://ftp-archive.freebsd.org/pub/FreeBSD/releases/powerpc/powerpcspe/13.1-RC3/base.txz
'
...
freebsd="${freebsd11}${freebsd12}${freebsd13}${freebsd14}"
openbsd="${openbsd7}"
netbsd="${netbsd9}"

case $1 in
    freebsd) sysroots="${freebsd}" ;;
    openbsd) sysroots="${openbsd}" ;;
    netbsd)  sysroots="${netbsd}" ;;
    all) sysroots="${freebsd}${openbsd}${netbsd}" ;;
    *)
        echo "syntax: $0 freebsd|openbsd|netbsd|all"
        exit 1 ;;
esac
...
if [ ! -f ${bsd_base}/usr/lib/libc.a ] ; then
    ...
    #--
    for i in \
        bin boot dev etc libexec mnt media net proc \
        rescue root sys tmp sbin stand var \
        usr/bin usr/sbin usr/libexec usr/libdata/perl5 \
        lib/i386 usr/lib/i386 libdata/firmware
    do
        if [ -d ${bsd_base}/${i} ] ; then
            rm -rf ${bsd_base}/${i}
        fi
    done
    #--
    #find ${bsd_base}/lib/ ${bsd_base}/usr/lib/ -mindepth 1 -maxdepth 1 -type d | \
    #while read l; do rm -rf $l ; done
...
if [ ! -f "${bsd_sysroot}/lib/libc.a" ] ; then
    ...
    #--
    if [ -d ${bsd_sysroot}/lib/clang ] ; then
